...
<div class="container-fluid">
	...
	<div class="panel panel-headline">
		<div class="panel-heading">
			<h3 class="panel-title">Pengaduan Proses</h3>
		</div>
	</div>
	<!-- END OVERVIEW -->
	<div class="row">
		<div class="col-md-12">
			...
			<div class="panel">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<a class="btn btn-warning edit" data-toggle="modal" id="{{$row->id_pengaduan}}" href='#' data-target='edit'><i class="fa fa-edit">
										@endif
									</td>
								</tr>
								@endforeach
				...
				<div class="panel-footer">
					<div class="row">
						<div class="col-md-6"><span class="panel-note"><i class="fa fa-bookmark"></i> Data Pengaduan Proses</span></div>
